...
def diffrun(z):    
    ...
    new_subnetwork2 = np.load('../../spike_input/'+parent_dir+'/'+'Br1/subnetwork2_input' + '_' + str(z) + '.npy', allow_pickle = True)
    new2_subnetwork1 = np.load('../../spike_input/'+parent_dir+'/'+'Br2/subnetwork1_input' + '_' + str(z) + '.npy', allow_pickle = True)
    new2_subnetwork2 = np.load('../../spike_input/'+parent_dir+'/'+'Br2/subnetwork2_input' + '_' + str(z) + '.npy', allow_pickle = True)
...
if __name__ == '__main__':  
    freeze_support()
    parent_dir1 = 'run_200619/Br1/'
    parent_dir2 = 'run_200619/Br2/'
    for z in range(1,3):
