...
from subnetwork_parallel_test import Subnetwork
import numpy as np
import time
import datetime
import winsound
...
for x in range(0,len(new_subnetwork1)): #loop through different spot diameter spike trains
    ...
    syn_IN1axon_IN2 = h.Exp2Syn(subnetwork2.IN_1.dend(0.5))
    ...
    syn_IN2axon_IN1 = h.Exp2Syn(subnetwork.IN_1.dend(0.5))
    ...
    syn_IN1dend_IN2 = h.Exp2Syn(subnetwork2.IN_1.dend(0.5))
    ...
    syn_IN2dend_IN1 = h.Exp2Syn(subnetwork.IN_1.dend(0.5))
    ...
    synBr1toIN2 = h.Exp2Syn(subnetwork2.IN_1.dend(0.5))
    ...
    synBr1toIN1 = h.Exp2Syn(subnetwork.IN_1.dend(0.5))
    ...
    synBr2toIN1 = h.Exp2Syn(subnetwork.IN_1.dend(0.5))
    ...
    synBr2toIN2 = h.Exp2Syn(subnetwork2.IN_1.dend(0.5))
