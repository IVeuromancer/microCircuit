...
class Subnetwork:
    ...
    def _add_IN_syn(self):
        for target in self.TCcells:
            ...
            self.nc.weight[0] = 0.0053 #0.0017 (cauases a 1mV IPSP)
            self.nc.delay = 0.97
