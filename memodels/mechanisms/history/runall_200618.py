...
def diffrun(z):    
    parent_dir = 'run_200618_no_triadic'
    
    N=4
    subnetwork = Subnetwork(0,N,100)
    subnetwork2 = Subnetwork(9,N,100) #gidStart should be number of gids (3 for IN + 2 for TC)

    new_subnetwork1 = np.load('../../spike_input/'+parent_dir+'/'+'subnetwork1_input' + '_' + str(z) + '.npy', allow_pickle = True)
    new_subnetwork2 = np.load('../../spike_input/'+parent_dir+'/'+'subnetwork2_input' + '_' + str(z) + '.npy', allow_pickle = True)
    ...
    diffIN_time_series = []
    diffIN_spike_events = []
    for x in range(31,len(new_subnetwork1)): #loop through different spot diameter spike trains
...
def samerun(z):     
    ...
    sameIN_time_series = []
    sameIN_spike_events = []
    for y in range(31,len(new_subnetwork1)): #loop through different spot diameter spike trains
        # change spike inputs to network
        ...
        synBr1toIN1.tau1 = 0.32
        synBr1toIN1.tau2 = 2.08 
        synBr1toIN1.e = 10 
        nc_Br1toIN1 = h.NetCon(subnetwork._vecstim, synBr1toIN1)
        nc_Br1toIN1.delay = 1 
        ...
        synBr1toIN2.tau1 = 0.29
        synBr1toIN2.tau2 = 2.15
        synBr1toIN2.e = 10
        nc_Br1toIN2 = h.NetCon(subnetwork._vecstim, synBr1toIN2)
        nc_Br1toIN2.delay = 1 
        ...
        synBr2toIN2.tau1 = 0.32
        synBr2toIN2.tau2 = 2.08
        synBr2toIN2.e = 10
        nc_Br2toIN2 = h.NetCon(subnetwork2._vecstim, synBr2toIN2)
        nc_Br2toIN2.delay = 1 
        ...
        synBr2toIN1.tau1 = 0.29
        synBr2toIN1.tau2 = 2.15
        synBr2toIN1.e = 10
        nc_Br2toIN1 = h.NetCon(subnetwork2._vecstim, synBr2toIN1)
        nc_Br2toIN1.delay = 1 
...
if __name__ == '__main__':  
    ...
    result1 = pool.map_async(diffrun,z)
    result2 = pool.map_async(samerun,z)
    print(result2.get())
    print(result1.get())
    freq = 440
    dur = 1000
