...
for z in range(6,11):
    ...
    new_subnetwork1 = np.load('../../spike_input/subnetwork1_input' + '_' + str(z) + '.npy', allow_pickle = True)
    new_subnetwork2 = np.load('../../spike_input/subnetwork2_input' + '_' + str(z) + '.npy', allow_pickle = True)
