...
class Subnetwork_no_axonal:
    ...
    def _add_IN_syn(self):
        ...
        #     self.nc.weight[0] = 0.002 #0.0017 (cauases a 1mV IPSP)
        #     self.nc.delay = 0.97
        ...
        for target in self.TCcells:
            if target._gid == 5 or target._gid == self.gidStart+5:
                ...
                self.nc2.weight[0] = 0.002 #0.0017 (causes a 1mV IPSP)
                self.nc2.delay = 0.1
            ...
            if target._gid == 6 or target._gid == self.gidStart+6:
                ...
                self.nc4.weight[0] = 0.002 #0.0017 (causes a 1mV IPSP)
                self.nc4.delay = 0.1
            ...
            if target._gid == 7 or target._gid == self.gidStart+7:
                ...
                self.nc5.weight[0] = 0.002 #0.0017 (causes a 1mV IPSP)
                self.nc5.delay = 0.1
            ...
            if target._gid == 8 or target._gid == self.gidStart+8:
                ...
                self.nc6.weight[0] = 0.002 #0.0017 (causes a 1mV IPSP)
                self.nc6.delay = 0.1
