...
class IN(Cell):
    ...
    def _setup_cell(self):
        ...
        self.syn_Brprox = h.DetAMPANMDA(self.model.dend[0](0.5))
        self.syn_Brprox.tau_r_AMPA = 0.37
        self.syn_Brprox. tau_d_AMPA = 1.65
        self.syn_Brprox.e = 10
        self.syn_Brprox.Use = 0.48
        self.syn_Brprox.Dep = 690
        self.syn_Brprox.Fac = 57

        # self.syn_Brprox2 = h.DetAMPDANMDA(self.model.dend[25](1))
        # self.syn_Brprox2.tau_r_AMPA = 0.37
        # self.syn_Brprox2.tau_d_AMPA = 1.65
        # self.syn_Brprox2.e = 10
        # self.syn_Brprox2.Use = 0.48
        # self.syn_Brprox2.Dep = 690
        # self.syn_Brprox2.Fac = 57
        
        # self.syn_INprox2 = h.DetAMPANMDA(self.model.dend[25](1))
        # self.syn_INprox2.tau_r_AMPA = 0.71
        # self.syn_INprox2.tau_d_AMPA = 4.18
        # self.syn_INprox2.e_GABAA = -80
        # self.syn_INprox2.Use = 
        # self.syn_INprox2.Dep = 
        # self.syn_INprox2.Fac = 
        
        self.syn_Brdist = h.DetAMPANMDA(self.model.dend[20](1))
        self.syn_Brdist.tau_r_AMPA = 0.36
        self.syn_Brdist.tau_d_AMPA = 1.77
        self.syn_Brdist.e = 10
        self.syn_Brdist.Use = 0.48
        self.syn_Brdist.Dep = 690
        self.syn_Brdist.Fac = 57

        # uncomment for Heiberg simulation
        # self.syn_Brdist2 = h.DetAMPNMDA(self.model.dend[85](1))
        # self.syn_Brdist2.tau_r_AMPA = 0.36
        # self.syn_Brdist2.tau_d_AMPA = 1.77
        # self.syn_Brdist2.e = 10
        # self.syn_Brdist2.Use = 0.48
        # self.syn_Brdist2.Dep = 690
        # self.syn_Brdist2.Fac = 57
        
        self.syn_Brdist3 = h.DetAMPANMDA(self.model.dend[79](1))
        self.syn_Brdist3.tau_r_AMPA = 0.36
        self.syn_Brdist3.tau_d_AMPA = 1.77
        self.syn_Brdist3.e = 10
        self.syn_Brdist3.Use = 0.48
        self.syn_Brdist3.Dep = 690
        self.syn_Brdist3.Fac = 57
        
        self.syn_Brdist4 = h.DetAMPANMDA(self.model.dend[92](1))
        self.syn_Brdist4.tau_r_AMPA = 0.36
        self.syn_Brdist4.tau_d_AMPA = 1.77
        self.syn_Brdist4.e = 10
        self.syn_Brdist4.Use = 0.48
        self.syn_Brdist4.Dep = 690
        self.syn_Brdist4.Fac = 57
        
        self.syn_Brdist5 = h.DetAMPANMDA(self.model.dend[104](1))
        self.syn_Brdist5.tau_r_AMPA = 0.36
        self.syn_Brdist5.tau_d_AMPA = 1.77
        self.syn_Brdist5.e = 10
        self.syn_Brdist5.Use = 0.48
        self.syn_Brdist5.Dep = 690
        self.syn_Brdist5.Fac = 57
...
class TC(Cell):
    ...
    def _setup_cell(self):
        ...
        self.syn_Br = h.DetAMPANMDA(self.model.dend[0](1))
        self.syn_Br.tau_r_AMPA = 0.59
        self.syn_Br.tau_d_AMPA = 2.73
        self.syn_Br.e = 1
        self.syn_Br.Use = 0.12
        self.syn_Br.Dep = 955.2
        self.syn_Br.Fac = 39.8

        # add synapses received from IN
        # INaxon to TC is .syn_INaxonal
        # INdendrite to TC is .syn_INdendritic (dendro-dendritic synapse)
        self.syn_INaxonal = h.DetGABAAB(self.model.dend[0](1))
        self.syn_INaxonal.tau_r_GABAA = 0.71
        self.syn_INaxonal.tau_d_GABAA = 4.18
        self.syn_INaxonal.e_GABAA = -80
        self.syn_INaxonal.Use = 0.35
        self.syn_INaxonal.Dep = 189
        self.syn_INaxonal.Fac = 5

        self.syn_INdendritic = h.DetGABAAB(self.model.dend[0](1))
        self.syn_INdendritic.tau_r_GABAA = 0.71
        self.syn_INdendritic.tau_d_GABAA = 4.18
        self.syn_INdendritic.e_GABAA = -80
        self.syn_INdendritic.Use = 0.35
        self.syn_INdendritic.Dep = 189
        self.syn_INdendritic.Fac = 5
